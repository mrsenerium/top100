...
@section('title')
    Round 1 Judging - {{$candidate->user->firstname}} {{$candidate->user->lastname}}
@endsection
...
@section('content')
    <div class="col-md-12">
        ...
        <form action="{{route('judging::round1.rate.save', ['candidateid' => $candidate->id])}}" method="post" class="col-md-8 col-md-pull-4">
            ...
            <p>Provide a score for each section where 0 is the worst and 5 is the best. You must provide a score for each section before saving.</p>
