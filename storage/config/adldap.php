            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'base_dn' => 'CN=Users,DC=butler,DC=edu',
                ...
                */
                ...
                'admin_account_suffix' => '@butler.edu',
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'internetvisitor'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', '!2bZw3#E'),
