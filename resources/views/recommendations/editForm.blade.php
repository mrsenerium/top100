    ...
    <div class="col-md-12">
        ...
        <form method="post">
          ...
          <div class="form-group {{$errors->has('recommendation_body') ? 'has-error' : ''}}">
            ...
            <textarea name="recommendation_body" id="recommendation_body" class="form-control wysiwyg" rows="5">{{$recommendation->message}}</textarea>
          ...
          <div class="well well-sm">
              ...
              <a href="{{route('application::view', ['id' => $candidate->id])}}" class="btn btn-default">Cancel</a>
          </div>
